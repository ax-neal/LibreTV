...
!(function (e, t, r, a, o, i, n, s) {
  ...
  function f(t, r) {
    if (!u[t]) {
      ...
      (p.resolve = function (r) {
        ...
        (p.cache = {});
      var s = (u[t] = new f.Module(t));
      e[t][0].call(s.exports, p, s, s.exports, l);
    }
    return u[t].exports;
    function p(e) {
      var t = p.resolve(e);
  ...
  (f.isParcelRequire = !0),
    (f.Module = function (e) {
      (this.id = e), (this.bundle = f), (this.require = d), (this.exports = {});
    }),
    (f.modules = e),
    (f.cache = u),
    (f.parent = c),
...
})(
  {
    jz4E5: [
      function (e, t, r, a) {
        ...
        var i = e("../package.json"),
          n = e("bundle-text:./style/index.less"),
          s = o.interopDefault(n),
          l = e("option-validator"),
          ...
          E = e("./contextmenu"),
          z = o.interopDefault(E),
          $ = e("./info"),
          I = o.interopDefault($),
          T = e("./subtitle"),
          M = o.interopDefault(T),
          F = e("./events"),
          P = o.interopDefault(F),
          C = e("./hotkey"),
          D = o.interopDefault(C),
          A = e("./layer"),
          R = o.interopDefault(A),
          L = e("./loading"),
          O = o.interopDefault(L),
          q = e("./notice"),
          _ = o.interopDefault(q),
          H = e("./mask"),
          ...
          Q = e("./plugins"),
          X = o.interopDefault(Q);
        let Z = 0,
          G = [];
        class J extends u.default {
          constructor(e, t) {
            super(), (this.id = ++Z);
            let r = d.mergeDeep(J.option, e);
            if (
              ((r.container = e.container),
              (this.option = (0, c.default)(r, h.default)),
              (this.isLock = !1),
              (this.isReady = !1),
              (this.isFocus = !1),
              (this.isInput = !1),
              (this.isRotate = !1),
              (this.isDestroy = !1),
              (this.template = new (0, y.default)(this)),
              (this.events = new (0, P.default)(this)),
              (this.storage = new (0, K.default)(this)),
              (this.icons = new (0, B.default)(this)),
              (this.i18n = new (0, x.default)(this)),
              (this.notice = new (0, _.default)(this)),
              (this.player = new (0, j.default)(this)),
              (this.layers = new (0, R.default)(this)),
              (this.controls = new (0, S.default)(this)),
              (this.contextmenu = new (0, z.default)(this)),
              ...
              (this.setting = new (0, Y.default)(this)),
              ...
              e("Version@" + J.version);
              for (let t = 0; t < g.default.events.length; t++)
                this.on("video:" + g.default.events[t], (t) =>
                  e("Event@" + t.type)
                );
            }
            G.push(this);
          ...
          static get option() {
            return {
              ...
              moreVideoAttr: {
                controls: !1,
                preload: d.isSafari ? "auto" : "metadata",
              },
              i18n: {},
              icons: {},
              cssVar: {},
        ...
        (r.default = J),
          ...
          (J.NOTICE_TIME = 2e3),
          (J.SETTING_WIDTH = 250),
          (J.SETTING_ITEM_WIDTH = 200),
          (J.SETTING_ITEM_HEIGHT = 35),
          (J.RESIZE_TIME = 200),
          (J.SCROLL_TIME = 200),
          (J.SCROLL_GAP = 50),
          (J.AUTO_PLAYBACK_MAX = 10),
          (J.AUTO_PLAYBACK_MIN = 5),
          (J.AUTO_PLAYBACK_TIMEOUT = 3e3),
          (J.RECONNECT_TIME_MAX = 5),
          (J.RECONNECT_SLEEP_TIME = 1e3),
          (J.CONTROL_HIDE_TIME = 3e3),
          (J.DBCLICK_TIME = 300),
          (J.DBCLICK_FULLSCREEN = !0),
          (J.MOBILE_DBCLICK_PLAY = !0),
          (J.MOBILE_CLICK_PLAY = !1),
          (J.AUTO_ORIENTATION_TIME = 200),
          (J.INFO_LOOP_TIME = 1e3),
          (J.FAST_FORWARD_VALUE = 3),
          (J.FAST_FORWARD_TIME = 1e3),
          (J.TOUCH_MOVE_RATIO = 0.5),
          (J.VOLUME_STEP = 0.1),
          (J.SEEK_STEP = 5),
          (J.PLAYBACK_RATE = [0.5, 0.75, 1, 1.25, 1.5, 2]),
          (J.ASPECT_RATIO = ["default", "4:3", "16:9"]),
          (J.FLIP = ["normal", "horizontal", "vertical"]),
          (J.FULLSCREEN_WEB_IN_BODY = !1),
          (J.LOG_VERSION = !0),
          (J.USE_RAF = !1),
          d.isBrowser &&
            ((window.Artplayer = J),
            d.setStyleText("artplayer-style", s.default),
            setTimeout(() => {
              J.LOG_VERSION &&
                console.log(
                  `%c ArtPlayer %c ${J.version} %c https://artplayer.org`,
      ...
      {
        "../package.json": "aQnLI",
        "bundle-text:./style/index.less": "6KiDz",
        "option-validator": "49gY0",
        "./utils/emitter": "b0EdR",
        "./utils": "gpvEP",
        "./scheme": "bEi0U",
        "./config": "eQRJX",
        ...
        t.exports = (function () {
          ...
          var t = Object.prototype.toString,
            r = function (r) {
              ...
              if ("function" === o)
                return "GeneratorFunction" === a(r)
                  ? "generatorfunction"
                  : "function";
              if (Array.isArray ? Array.isArray(r) : r instanceof Array)
                return "array";
              if (
                r.constructor &&
    ...
    jghk1: [
      function (e, t, r, a) {
        ...
        o.defineInteropFlag(r),
          ...
          o.export(r, "addClass", () => l),
          o.export(r, "removeClass", () => c),
          o.export(r, "hasClass", () => p),
          o.export(r, "append", () => u),
          o.export(r, "remove", () => d),
          o.export(r, "setStyle", () => f),
          o.export(r, "setStyles", () => h),
          o.export(r, "getStyle", () => m),
          o.export(r, "siblings", () => g),
          o.export(r, "inverseClass", () => v),
          o.export(r, "tooltip", () => y),
          o.export(r, "isInViewport", () => b),
          o.export(r, "includeFromEvent", () => x),
          o.export(r, "replaceElement", () => w),
          o.export(r, "createElement", () => j),
          o.export(r, "getIcon", () => k),
          o.export(r, "setStyleText", () => S),
          o.export(r, "supportsFlex", () => E),
          o.export(r, "getRect", () => z),
          o.export(r, "loadImg", () => $);
        ...
        function k(e = "", t = "") {
          let r = j("i");
          return l(r, "art-icon"), l(r, `art-icon-${e}`), u(r, t), r;
        }
        function S(e, t) {
          let r = document.getElementById(e);
          r ||
            (((r = document.createElement("style")).id = e),
    ...
    h19pd: [
      function (e, t, r, a) {
        ...
        o.defineInteropFlag(r),
          ...
          o.export(r, "isIOS", () => p),
          o.export(r, "isIOS13", () => u),
          o.export(r, "isMobile", () => d),
          o.export(r, "isBrowser", () => f);
        let i =
          ...
          u = p || (i.includes("Macintosh") && navigator.maxTouchPoints >= 1),
          d =
    ...
    "4YeYK": [
      function (e, t, r, a) {
        ...
        o.defineInteropFlag(r),
          o.export(r, "clamp", () => i),
          o.export(r, "capitalize", () => n),
          o.export(r, "secondToTime", () => s),
          o.export(r, "escape", () => l),
      ...
      function (e, t, r, a) {
        ...
        function d(e, t, r) {
          return (0, i.errorHandle)(
            t === l || t === c || e instanceof Element,
            `${r.join(".")} require '${l}' or 'Element' type`
          );
        }
        let f = {
          html: d,
        ...
        r.default = {
          ...
          quality: [{ default: `?${s}`, html: l, url: l }],
          highlight: [{ time: c, text: l }],
          thumbnails: {
            url: l,
            number: c,
            column: c,
        ...
        class n {
          constructor(e) {
            ...
            t.container instanceof Element
              ...
              : ((this.$container = (0, i.query)(t.container)),
                (0, i.errorHandle)(
                  this.$container,
              ...
              (0, i.errorHandle)(
                (0, i.supportsFlex)(),
                "The current browser does not support flex layout"
              );
            let a = this.$container.tagName.toLowerCase();
            (0, i.errorHandle)(
              "div" === a,
          ...
          query(e) {
            return (0, i.query)(e, this.$container);
          }
          init() {
            ...
            if (
              ...
              (0, i.errorHandle)(
                t instanceof HTMLVideoElement || t instanceof HTMLCanvasElement,
                "Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'"
              ),
                (0, i.replaceElement)(t, this.$video),
                (t.className = "art-video"),
                (this.$video = t);
            }
            e.backdrop && (0, i.addClass)(this.$player, "art-backdrop"),
              i.isMobile && (0, i.addClass)(this.$player, "art-mobile");
          }
          destroy(e) {
            (this.$video.src = ""),
              e
                ? (this.$container.innerHTML = "")
                : (0, i.addClass)(this.$player, "art-destroy");
          }
        }
        r.default = n;
      },
    ...
    "3xuL2": [
      function (e, t, r, a) {
        ...
        var i = e("./urlMix"),
          ...
          X = o.interopDefault(Q),
          Z = e("./posterMix"),
          G = o.interopDefault(Z),
          J = e("./autoHeightMix"),
          ee = o.interopDefault(J),
          et = e("./cssVarMix"),
          er = o.interopDefault(et),
          ea = e("./themeMix"),
          eo = o.interopDefault(ea),
          ei = e("./typeMix"),
          en = o.interopDefault(ei),
          es = e("./stateMix"),
          el = o.interopDefault(es),
          ec = e("./subtitleOffsetMix"),
          ep = o.interopDefault(ec),
          eu = e("./airplayMix"),
          ed = o.interopDefault(eu),
          ef = e("./qualityMix"),
          eh = o.interopDefault(ef),
          em = e("./thumbnailsMix"),
          eg = o.interopDefault(em),
          ev = e("./optionInit"),
          ey = o.interopDefault(ev),
          eb = e("./eventInit"),
          ex = o.interopDefault(eb);
        r.default = class {
          constructor(e) {
            (0, n.default)(e),
              (0, l.default)(e),
      ...
      },
      {
        ...
        "./seekMix": "kNVxo",
        "./volumeMix": "j0CPw",
        "./currentTimeMix": "3Qlk2",
        "./durationMix": "ej83c",
        "./switchMix": "4DKMC",
        "./playbackRateMix": "3q2BJ",
        "./aspectRatioMix": "kKNdy",
        "./screenshotMix": "jEOGf",
        "./fullscreenMix": "6fcMx",
        "./fullscreenWebMix": "2fgOZ",
        "./pipMix": "7ctTv",
        "./loadedMix": "748cK",
        "./playedMix": "2v3kJ",
        "./playingMix": "7NTUH",
        ...
        function n(e) {
          ...
          (0, i.def)(e, "url", {
            ...
            async set(a) {
              if (a) {
                let o = e.url,
                  n = t.type || (0, i.getExt)(a),
                  s = t.customType[n];
                n && s
                  ? (await (0, i.sleep)(),
                    (e.loading.show = !0),
                    s.call(e, r, a, e))
                  : (URL.revokeObjectURL(o), (r.src = a)),
                  o !== e.url &&
                    ((e.option.url = a),
                    e.isReady &&
                      o &&
        ...
        function n(e) {
          ...
          (0, i.def)(e, "seek", {
            set(r) {
              (e.currentTime = r),
                e.duration &&
                  (t.show = `${(0, i.secondToTime)(e.currentTime)} / ${(0,
                  i.secondToTime)(e.duration)}`),
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          (0, i.def)(e, "volume", {
            get: () => t.volume || 0,
            set: (e) => {
              (t.volume = (0, i.clamp)(e, 0, 1)),
                (a.show = `${r.get("Volume")}: ${parseInt(
                  100 * t.volume,
                  10
                )}`),
                0 !== t.volume && o.set("volume", t.volume);
            },
          }),
            (0, i.def)(e, "muted", {
              get: () => t.muted,
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          (0, i.def)(e, "currentTime", {
            get: () => t.currentTime || 0,
            set: (r) => {
              Number.isNaN((r = parseFloat(r))) ||
                (t.currentTime = (0, i.clamp)(r, 0, e.duration));
            },
          });
        }
      },
        ...
        function n(e) {
          function t(t, r) {
            return new Promise((a, o) => {
              if (t === e.url) return;
              let { playing: i, aspectRatio: n, playbackRate: s } = e;
              e.pause(),
                (e.url = t),
                (e.notice.show = ""),
          ...
          (0, i.def)(e, "switchQuality", { value: (r) => t(r, e.currentTime) }),
            (0, i.def)(e, "switchUrl", { value: (e) => t(e, 0) }),
            (0, i.def)(e, "switch", { set: e.switchUrl });
        }
      },
      {
        "../utils": "gpvEP",
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          (0, i.def)(e, "aspectRatio", {
            ...
            set(n) {
              if ((n || (n = "default"), "default" === n))
                (0, i.setStyle)(a, "width", null),
                  (0, i.setStyle)(a, "height", null),
                  (0, i.setStyle)(a, "margin", null),
                  delete o.dataset.aspectRatio;
              else {
                let e = n.split(":").map(Number),
                  { clientWidth: t, clientHeight: r } = o,
                  s = e[0] / e[1];
                t / r > s
                  ? ((0, i.setStyle)(a, "width", `${s * r}px`),
                    (0, i.setStyle)(a, "height", "100%"),
                    (0, i.setStyle)(a, "margin", "0 auto"))
                  : ((0, i.setStyle)(a, "width", "100%"),
                    (0, i.setStyle)(a, "height", `${t / s}px`),
                    (0, i.setStyle)(a, "margin", "auto 0")),
                  (o.dataset.aspectRatio = n);
              }
              (r.show = `${t.get("Aspect Ratio")}: ${
                "default" === n ? t.get("Default") : n
              }`),
          ...
          (0, i.def)(e, "getDataURL", {
            ...
            (0, i.def)(e, "screenshot", {
              value: async (t) => {
                ...
                return (
                  (0, i.download)(a, `${o}.png`), e.emit("screenshot", a), a
                );
              },
            });
        }
              ...
              n.default.on("change", () => {
                e.emit("fullscreen", n.default.isFullscreen),
                  n.default.isFullscreen
                    ? ((e.state = "fullscreen"),
                      (0, s.addClass)(o, "art-fullscreen"))
                    : (0, s.removeClass)(o, "art-fullscreen"),
                  e.emit("resize");
              }),
                n.default.on("error", (t) => {
                  e.emit("fullscreenError", t);
                }),
                (0, s.def)(e, "fullscreen", {
                  get: () => n.default.isFullscreen,
                  async set(e) {
                    e ? await n.default.request(o) : await n.default.exit();
                  },
                });
            },
            l = (e) => {
              e.proxy(document, "webkitfullscreenchange", () => {
                ...
                (0, s.def)(e, "fullscreen", {
                  ...
                  set(t) {
                    t
                      ? ((e.state = "fullscreen"), a.webkitEnterFullscreen())
    ...
    "2fgOZ": [
      function (e, t, r, a) {
        ...
        function n(e) {
          let {
              constructor: t,
              template: { $container: r, $player: a },
            } = e,
            o = "";
          (0, i.def)(e, "fullscreenWeb", {
            get: () => (0, i.hasClass)(a, "art-fullscreen-web"),
            set(n) {
              n
                ? ((o = a.style.cssText),
                  t.FULLSCREEN_WEB_IN_BODY && (0, i.append)(document.body, a),
                  (e.state = "fullscreenWeb"),
                  (0, i.setStyle)(a, "width", "100%"),
                  (0, i.setStyle)(a, "height", "100%"),
                  (0, i.addClass)(a, "art-fullscreen-web"),
                  e.emit("fullscreenWeb", !0))
                : (t.FULLSCREEN_WEB_IN_BODY && (0, i.append)(r, a),
                  o && ((a.style.cssText = o), (o = "")),
                  (0, i.removeClass)(a, "art-fullscreen-web"),
    ...
    "7ctTv": [
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          } else if (a.webkitSupportsPresentationMode) {
            let { $video: t } = e.template;
    ...
    "748cK": [
      function (e, t, r, a) {
        ...
        function n(e) {
          let { $video: t } = e.template;
          (0, i.def)(e, "loaded", { get: () => e.loadedTime / t.duration }),
            (0, i.def)(e, "loadedTime", {
              get: () =>
          ...
          (0, i.def)(e, "autoSize", {
            value() {
              let { videoWidth: o, videoHeight: n } = a,
                { width: s, height: l } = (0, i.getRect)(t),
                c = o / n;
              s / l > c
                ? ((0, i.setStyle)(r, "width", `${((l * c) / s) * 100}%`),
                  (0, i.setStyle)(r, "height", "100%"))
                : ((0, i.setStyle)(r, "width", "100%"),
                  (0, i.setStyle)(r, "height", `${(s / c / l) * 100}%`)),
    ...
    i0rvQ: [
      function (e, t, r, a) {
        ...
        function n(e) {
          (0, i.def)(e, "rect", {
            get: () => (0, i.getRect)(e.template.$player),
          });
          ...
          (0, i.def)(e, "x", { get: () => e.left + window.pageXOffset }),
            (0, i.def)(e, "y", { get: () => e.top + window.pageYOffset });
        }
      },
      {
        "../utils": "gpvEP",
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          (0, i.def)(e, "flip", {
            ...
            set(o) {
              o || (o = "normal"),
                "normal" === o ? delete t.dataset.flip : (t.dataset.flip = o),
                (a.show = `${r.get("Video Flip")}: ${r.get(
                  (0, i.capitalize)(o)
                )}`),
                e.emit("flip", o);
            },
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          function p() {
            ...
            t &&
              ((0, i.removeClass)(o, "art-mini"),
              (0, i.setStyle)(t, "display", "none"),
              o.prepend(n),
              e.emit("mini", !1));
          }
          function u(t, r) {
            e.playing
              ? ((0, i.setStyle)(t, "display", "none"),
                (0, i.setStyle)(r, "display", "flex"))
              : ((0, i.setStyle)(t, "display", "flex"),
                (0, i.setStyle)(r, "display", "none"));
          }
          function d() {
            let { $mini: t } = e.template,
              r = (0, i.getRect)(t),
              o = window.innerHeight - r.height - 50,
              n = window.innerWidth - r.width - 50;
            a.set("top", o),
              a.set("left", n),
              (0, i.setStyle)(t, "top", `${o}px`),
              (0, i.setStyle)(t, "left", `${n}px`);
          }
          (0, i.def)(e, "mini", {
            get: () => (0, i.hasClass)(o, "art-mini"),
            set(f) {
              if (f) {
                ...
                let f = (function () {
                    ...
                    if (o)
                      return (
                        (0, i.append)(o, n),
                        (0, i.setStyle)(o, "display", "flex")
                      );
                    {
                      let o = (0, i.createElement)("div");
                      (0, i.addClass)(o, "art-mini-popup"),
                        (0, i.append)(document.body, o),
                        (e.template.$mini = o),
                        (0, i.append)(o, n);
                      let d = (0, i.append)(
                        o,
                      ...
                      (0, i.append)(d, t.close), r(d, "click", p);
                      let f = (0, i.append)(
                          o,
                          '<div class="art-mini-state"></div>'
                        ),
                        h = (0, i.append)(f, t.play),
                        m = (0, i.append)(f, t.pause);
                      return (
                        r(h, "click", () => e.play()),
                        r(m, "click", () => e.pause()),
                        u(h, m),
                        ...
                        e.on("document:mousemove", (e) => {
                          if (s) {
                            (0, i.addClass)(o, "art-mini-dragging");
                            let t = e.pageX - l,
                              r = e.pageY - c;
                            (0, i.setStyle)(
                              o,
                        ...
                        e.on("document:mouseup", () => {
                          if (s) {
                            (s = !1),
                              (0, i.removeClass)(o, "art-mini-dragging");
                            let e = (0, i.getRect)(o);
                            a.set("left", e.left),
                              a.set("top", e.top),
                              (0, i.setStyle)(o, "left", `${e.left}px`),
                              (0, i.setStyle)(o, "top", `${e.top}px`),
                              (0, i.setStyle)(o, "transform", null);
                          }
                        }),
                        o
                      );
                  ...
                  h = a.get("top"),
                  m = a.get("left");
                "number" == typeof h && "number" == typeof m
                  ? ((0, i.setStyle)(f, "top", `${h}px`),
                    (0, i.setStyle)(f, "left", `${m}px`),
                    (0, i.isInViewport)(f) || d())
                  : d(),
                  e.emit("mini", !0);
              } else p();
            },
    ...
    eqBmH: [
      function (e, t, r, a) {
        ...
        var i = e("../utils");
        function n(e) {
          let { notice: t, i18n: r, template: a } = e;
          (0, i.def)(e, "subtitleOffset", {
            get: () => a.$track?.offset || 0,
            set(o) {
              let { cues: n } = e.subtitle;
              if (!a.$track || 0 === n.length) return;
              let s = (0, i.clamp)(o, -10, 10);
              a.$track.offset = s;
              for (let t = 0; t < n.length; t++) {
                let r = n[t];
                (r.originalStartTime = r.originalStartTime ?? r.startTime),
                  (r.originalEndTime = r.originalEndTime ?? r.endTime),
                  (r.startTime = (0, i.clamp)(
                    r.originalStartTime + s,
                    0,
                    e.duration
                  )),
                  (r.endTime = (0, i.clamp)(
              ...
              e.subtitle.update(),
                (t.show = `${r.get("Subtitle Offset")}: ${o}s`),
    ...
    etKzV: [
      function (e, t, r, a) {
        ...
        function n(e) {
          ...
          o.webkitShowPlaybackTargetPicker
            ? a(o, "webkitplaybacktargetavailabilitychanged", (e) => {
            ...
            (0, i.def)(e, "airplay", {
              value() {
                n
                  ? (o.webkitShowPlaybackTargetPicker(), e.emit("airplay"))
    ...
    "1CuDr": [
      function (e, t, r, a) {
        ...
        function n(e) {
          (0, i.def)(e, "quality", {
            set(t) {
              let { controls: r, notice: a, i18n: o } = e,
                i = t.find((e) => e.default) || t[0];
              r.update({
                name: "quality",
                position: "right",
                index: 10,
          ...
          t.hover(
            ...
            e.on("setBar", async (t, u, d) => {
              let f = e.controls?.thumbnails,
                { url: h, scale: m } = r.thumbnails;
              if (!f || !h) return;
              let g = "played" === t && d && i.isMobile;
              if ("hover" === t || g) {
                if (
                  (l || ((l = !0), (s = await (0, i.loadImg)(h, m)), (c = !0)),
                  !c || !p)
                )
                  return;
                let t = a.clientWidth * u;
                (0, i.setStyle)(f, "display", "flex"),
                  t > 0 && t < a.clientWidth
                    ? (function (t) {
                        ...
                        let {
                          ...
                          f = p * d || s.naturalWidth / c,
                          h = u * d || f / (o.videoWidth / o.videoHeight),
                          m = Math.floor(t / (a.clientWidth / l)),
                          g = Math.ceil(m / c) - 1;
                        (0, i.setStyle)(n, "backgroundImage", `url(${s.src})`),
                          (0, i.setStyle)(n, "height", `${h}px`),
                          (0, i.setStyle)(n, "width", `${f}px`),
                          (0, i.setStyle)(
                            n,
                            "backgroundPosition",
                            `-${(m % c || c - 1) * f}px -${g * h}px`
                          ...
                          t <= f / 2
                            ...
                            : (0, i.setStyle)(n, "left", `${t - f / 2}px`);
                      })(t)
                    : i.isMobile || (0, i.setStyle)(f, "display", "none"),
                  g &&
                    (clearTimeout(n),
                    (n = setTimeout(() => {
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          let {
            option: t,
            storage: r,
            template: { $video: a, $poster: o },
          } = e;
          for (let r in t.moreVideoAttr) e.attr(r, t.moreVideoAttr[r]);
          t.muted && (e.muted = t.muted),
            t.volume && (a.volume = (0, i.clamp)(t.volume, 0, 1));
          let n = r.get("volume");
          for (let r in ("number" == typeof n &&
            (a.volume = (0, i.clamp)(n, 0, 1)),
          t.poster && (0, i.setStyle)(o, "backgroundImage", `url(${t.poster})`),
          t.autoplay && (a.autoplay = t.autoplay),
          t.playsInline &&
            ((a.playsInline = !0), (a["webkit-playsinline"] = !0)),
          t.theme && (t.cssVar["--art-theme"] = t.theme),
          t.cssVar))
            e.cssVar(r, t.cssVar[r]);
          e.url = t.url;
        }
      },
      {
          ...
          e.on("video:canplay", () => {
            ...
            e.on("video:error", async (i) => {
              u < o.RECONNECT_TIME_MAX
                ? (await (0, s.sleep)(o.RECONNECT_SLEEP_TIME),
                  (u += 1),
                  (e.url = a.url),
        ...
        class I extends n.default {
          constructor(e) {
            super(e),
              ...
              (this.timer = Date.now());
            let { constructor: t } = e,
              { $player: r, $bottom: a } = this.art.template;
            e.on("mousemove", () => {
              $.isMobile || (this.show = !0);
            }),
              e.on("click", () => {
                $.isMobile ? this.toggle() : (this.show = !0);
              }),
              e.on("document:mousemove", (e) => {
                this.isHover = (0, $.includeFromEvent)(e, a);
              }),
              e.on("video:timeupdate", () => {
                !e.setting.show &&
                  !this.isHover &&
              ...
              e.on("control", (e) => {
                e
                  ? ((0, $.removeClass)(r, "art-hide-cursor"),
                    (0, $.addClass)(r, "art-hover"),
                    (this.timer = Date.now()))
                  : ((0, $.addClass)(r, "art-hide-cursor"),
                    (0, $.removeClass)(r, "art-hover"));
              }),
              this.init();
          }
          init() {
            ...
            e.isLive ||
              ...
              this.add({ name: "thumbnails", position: "top", index: 20 }),
              this.add(
                (0, h.default)({
                  name: "playAndPause",
                  position: "left",
          ...
          check(e) {
            ...
            for (let t = 0; t < e.$control_option.length; t++) {
              ...
              (r.default = r === e),
                r.default &&
                  (0, $.inverseClass)(r.$control_item, "art-current");
            }
          }
          selector(e, t, r) {
            let { proxy: a } = this.art.events;
            (0, $.addClass)(t, "art-control-selector");
            let o = (0, $.createElement)("div");
            (0, $.addClass)(o, "art-selector-value"),
              (0, $.append)(o, e.html),
              (t.innerText = ""),
              (0, $.append)(t, o);
            let i = (0, $.createElement)("div");
            (0, $.addClass)(i, "art-selector-list"), (0, $.append)(t, i);
            for (let t = 0; t < e.selector.length; t++) {
              let r = e.selector[t],
                a = (0, $.createElement)("div");
              (0, $.addClass)(a, "art-selector-item"),
                r.default && (0, $.addClass)(a, "art-current"),
                (a.dataset.index = t),
                (a.dataset.value = r.value),
                (a.innerHTML = r.html),
                (0, $.append)(i, a),
                (0, $.def)(r, "$control_option", { get: () => e.selector }),
                (0, $.def)(r, "$control_item", { get: () => a }),
                (0, $.def)(r, "$control_value", { get: () => o });
            }
            let n = a(i, "click", async (t) => {
              let r = t.composedPath() || [],
                a = e.selector.find(
                  (e) =>
                    e.$control_item === r.find((t) => e.$control_item === t)
                );
              this.check(a),
                e.onSelect &&
                  (o.innerHTML = await e.onSelect.call(
                    this.art,
                    a,
                    a.$control_item,
                    t
    ...
    j4qZZ: [
      function (e, t, r, a) {
        ...
        r.default = class {
          ...
          set show(e) {
            let { $player: t } = this.art.template,
              r = `art-${this.name}-show`;
            e ? (0, i.addClass)(t, r) : (0, i.removeClass)(t, r),
          ...
          add(e) {
            ...
            (0, n.errorHandle)(
              ...
              (this.id += 1);
            let o = (0, i.createElement)("div");
            (0, i.addClass)(o, `art-${this.name}`),
              (0, i.addClass)(o, `art-${this.name}-${r}`);
            let s = Array.from(this.$parent.children);
            o.dataset.index = t.index || this.id;
            let p = s.find(
              (e) => Number(e.dataset.index) >= Number(o.dataset.index)
            );
            p
              ? p.insertAdjacentElement("beforebegin", o)
              : (0, i.append)(this.$parent, o),
            ...
            return (
              t.selector &&
                ...
                this.selector(t, o, u),
              (this[r] = o),
              this.cache.set(r, { $ref: o, events: u, option: t }),
          ...
          remove(e) {
            ...
            (0, n.errorHandle)(t, `Can't find [${e}] from the [${this.name}]`),
          ...
          return (t) => ({
            ...
            mounted: (e) => {
              let { proxy: r, icons: a, i18n: o } = t,
                n = (0, i.append)(e, a.fullscreenOn),
                s = (0, i.append)(e, a.fullscreenOff);
              (0, i.setStyle)(s, "display", "none"),
                r(e, "click", () => {
                  t.fullscreen = !t.fullscreen;
                }),
                t.on("fullscreen", (t) => {
                  t
                    ? ((0, i.tooltip)(e, o.get("Exit Fullscreen")),
                      (0, i.setStyle)(n, "display", "none"),
                      (0, i.setStyle)(s, "display", "inline-flex"))
                    : ((0, i.tooltip)(e, o.get("Fullscreen")),
                      (0, i.setStyle)(n, "display", "inline-flex"),
                      (0, i.setStyle)(s, "display", "none"));
                });
            },
          });
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          return (t) => ({
            ...
            mounted: (e) => {
              let { proxy: r, icons: a, i18n: o } = t,
                n = (0, i.append)(e, a.fullscreenWebOn),
              ...
              (0, i.setStyle)(s, "display", "none"),
                ...
                t.on("fullscreenWeb", (t) => {
                  t
                    ? ((0, i.tooltip)(e, o.get("Exit Web Fullscreen")),
                      (0, i.setStyle)(n, "display", "none"),
                      (0, i.setStyle)(s, "display", "inline-flex"))
                    : ((0, i.tooltip)(e, o.get("Web Fullscreen")),
                      (0, i.setStyle)(n, "display", "inline-flex"),
                      (0, i.setStyle)(s, "display", "none"));
                });
            },
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          return (t) => ({
            ...
            mounted: (e) => {
              let { proxy: r, icons: a, i18n: o } = t,
                n = (0, i.append)(e, a.play),
                s = (0, i.append)(e, a.pause);
              function l() {
                (0, i.setStyle)(n, "display", "flex"),
                  (0, i.setStyle)(s, "display", "none");
              }
              function c() {
                (0, i.setStyle)(n, "display", "none"),
                  (0, i.setStyle)(s, "display", "flex");
              }
              (0, i.tooltip)(n, o.get("Play")),
                (0, i.tooltip)(s, o.get("Pause")),
                r(n, "click", () => {
                  t.play();
                }),
                r(s, "click", () => {
    ...
    "2S7vj": [
      function (e, t, r, a) {
        var o = e("@parcel/transformer-js/src/esmodule-helpers.js");
        o.defineInteropFlag(r),
          o.export(r, "getPosFromEvent", () => n),
          o.export(r, "setCurrentTime", () => s),
          o.export(r, "default", () => l);
        var i = e("../utils");
        function n(e, t) {
          let { $progress: r } = e.template,
            { left: a } = (0, i.getRect)(r),
            o = i.isMobile ? t.touches[0].clientX : t.clientX,
            n = (0, i.clamp)(o - a, 0, r.clientWidth),
            s = (n / r.clientWidth) * e.duration,
            l = (0, i.secondToTime)(s),
        ...
        function s(e, t) {
          if (e.isRotate) {
            ...
            let { second: r, percentage: a } = n(e, t);
            e.emit("setBar", "played", a, t), (e.seek = r);
          }
        }
        function l(e) {
          return (t) => {
            let { icons: r, option: a, proxy: o } = t;
            return {
              ...e,
              ...
              mounted: (e) => {
                let l = null,
                  c = !1,
                  p = (0, i.query)(".art-progress-hover", e),
                  u = (0, i.query)(".art-progress-loaded", e),
                  d = (0, i.query)(".art-progress-played", e),
                  f = (0, i.query)(".art-progress-highlight", e),
                  h = (0, i.query)(".art-progress-indicator", e),
                  m = (0, i.query)(".art-progress-tip", e);
                function g(r, a) {
                  let { width: o, time: s } = a || n(t, r);
                  m.innerText = s;
                  let l = m.clientWidth;
                  o <= l / 2
                    ? (0, i.setStyle)(m, "left", 0)
                    : o > e.clientWidth - l / 2
                    ? (0, i.setStyle)(m, "left", `${e.clientWidth - l}px`)
                    : (0, i.setStyle)(m, "left", `${o - l / 2}px`);
                }
                r.indicator
                  ? (0, i.append)(h, r.indicator)
                  : (0, i.setStyle)(h, "backgroundColor", "var(--art-theme)"),
                  t.on("setBar", function (r, a, o) {
                    let n = "played" === r && o && i.isMobile;
                    "loaded" === r &&
                      (0, i.setStyle)(u, "width", `${100 * a}%`),
                      "hover" === r &&
                        (0, i.setStyle)(p, "width", `${100 * a}%`),
                      "played" === r &&
                        ((0, i.setStyle)(d, "width", `${100 * a}%`),
                        (0, i.setStyle)(h, "left", `${100 * a}%`)),
                      n &&
                        ((0, i.setStyle)(m, "display", "flex"),
                        g(o, {
                          width: e.clientWidth * a,
                          time: (0, i.secondToTime)(a * t.duration),
                        }),
                        clearTimeout(l),
                        (l = setTimeout(() => {
                  ...
                  t.on("video:loadedmetadata", function () {
                    ...
                    for (let e = 0; e < a.highlight.length; e++) {
                      let r = a.highlight[e],
                        o =
                          ((0, i.clamp)(r.time, 0, t.duration) / t.duration) *
                          100,
                  ...
                  t.emit("setBar", "loaded", t.loaded || 0),
                  i.isMobile ||
                    (o(e, "click", (e) => {
                      e.target !== h && s(t, e);
                    }),
                    o(e, "mousemove", (r) => {
                      let { percentage: a } = n(t, r);
                      if (
                        (t.emit("setBar", "hover", a, r),
                        (0, i.setStyle)(m, "display", "flex"),
                        (0, i.includeFromEvent)(r, f))
                      ) {
                        let { width: a } = n(t, r),
                          { text: o } = r.target.dataset;
                        m.innerText = o;
                        let s = m.clientWidth;
                        a <= s / 2
                          ? (0, i.setStyle)(m, "left", 0)
                          : a > e.clientWidth - s / 2
                          ? (0, i.setStyle)(m, "left", `${e.clientWidth - s}px`)
                          : (0, i.setStyle)(m, "left", `${a - s / 2}px`);
                      } else g(r);
                    }),
                    o(e, "mouseleave", (e) => {
                      (0, i.setStyle)(m, "display", "none"),
                        t.emit("setBar", "hover", 0, e);
                    }),
                    o(e, "mousedown", (e) => {
                      c = 0 === e.button;
                    }),
                    t.on("document:mousemove", (e) => {
                      if (c) {
                        let { second: r, percentage: a } = n(t, e);
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          return (t) => ({
            ...
            mounted: (e) => {
              function r() {
                let r = `${(0, i.secondToTime)(t.currentTime)} / ${(0,
                i.secondToTime)(t.duration)}`;
          ...
          return (t) => ({
            ...
            mounted: (e) => {
              let { proxy: r, icons: a } = t,
                o = (0, i.append)(e, a.volume),
                n = (0, i.append)(e, a.volumeClose),
                ...
                p = (0, i.append)(l, '<div class="art-volume-slider"></div>'),
                u = (0, i.append)(p, '<div class="art-volume-handle"></div>'),
                d = (0, i.append)(u, '<div class="art-volume-loaded"></div>'),
                f = (0, i.append)(
                  p,
                  '<div class="art-volume-indicator"></div>'
                );
              function h(e) {
                let { top: t, height: r } = (0, i.getRect)(p);
                return 1 - (e.clientY - t) / r;
              }
              function m() {
                if (t.muted || 0 === t.volume)
                  (0, i.setStyle)(o, "display", "none"),
                    (0, i.setStyle)(n, "display", "flex"),
                    (0, i.setStyle)(f, "top", "100%"),
                    (0, i.setStyle)(d, "top", "100%"),
                    (c.innerText = 0);
                else {
                  let e = 100 * t.volume;
                  (0, i.setStyle)(o, "display", "flex"),
                    (0, i.setStyle)(n, "display", "none"),
                    (0, i.setStyle)(f, "top", `${100 - e}%`),
                    (0, i.setStyle)(d, "top", `${100 - e}%`),
      ...
      function (e, t, r, a) {
        ...
        class x extends s.default {
          ...
          init() {
            ...
            e.playbackRate &&
              this.add((0, c.default)({ name: "playbackRate", index: 10 })),
              e.aspectRatio &&
                this.add((0, u.default)({ name: "aspectRatio", index: 20 })),
              e.flip && this.add((0, f.default)({ name: "flip", index: 30 })),
              this.add((0, m.default)({ name: "info", index: 40 })),
              this.add((0, v.default)({ name: "version", index: 50 })),
              this.add((0, b.default)({ name: "close", index: 60 }));
            ...
            t(r, "contextmenu", (e) => {
              ...
              let t = e.clientX,
                o = e.clientY,
                { height: n, width: s, left: l, top: c } = (0, i.getRect)(r),
                { height: p, width: u } = (0, i.getRect)(a),
                d = t - l,
                f = o - c;
              t + u > l + s && (d = s - u),
                o + p > c + n && (f = n - p),
                (0, i.setStyles)(a, { top: `${f}px`, left: `${d}px` });
            }),
              t(r, "click", (e) => {
              ...
              mounted: (e) => {
                ...
                r && (0, i.inverseClass)(r, "art-current"),
                  t.on("video:ratechange", () => {
                    let r = (0, i.queryAll)("span", e).find(
          ...
          o.export(
            ...
            () =>
              function (e) {
                return {
                  ...e,
                  html: `<a href="https://artplayer.org" target="_blank">ArtPlayer ${i.version}</a>`,
                };
              }
          );
        var i = e("../../package.json");
        ...
        class l extends s.default {
          ...
          init() {
            let {
              proxy: e,
              constructor: t,
              template: { $infoPanel: r, $infoClose: a, $video: o },
            } = this.art;
            e(a, "click", () => {
              this.show = !1;
            });
            let n = null,
              s = (0, i.queryAll)("[data-video]", r) || [];
    ...
    lEARb: [
      function (e, t, r, a) {
        ...
        class d extends s.default {
                ...
                (t.innerHTML = this.activeCues
                  .map((t, r) =>
                    t.text
                      ...
                      .map(
                        (t) =>
                          `<div class="art-subtitle-line" data-group="${r}">${
          ...
          async switch(e, t = {}) {
            let { i18n: r, notice: a, option: o } = this.art,
              i = { ...o.subtitle, ...t, url: e },
              n = await this.init(i);
            return (
              t.name && (a.show = `${r.get("Switch Subtitle")}: ${t.name}`), n
            );
          }
          createTrack(e, t) {
            let { template: r, proxy: a, option: o } = this.art,
              { $video: n, $track: s } = r,
              l = (0, i.createElement)("track");
            (l.default = !0),
              (l.kind = e),
              (l.src = t),
              (l.label = o.subtitle.name || "Artplayer"),
              (l.track.mode = "hidden"),
              (l.onload = () => {
              ...
              (0, i.append)(n, l),
              (r.$track = l),
              (this.destroyEvent = a(this.textTrack, "cuechange", () =>
                this.update()
              ));
          }
          async init(e) {
            ...
            return this.textTrack
              ? ((0, c.default)(e, u.default.subtitle), e.url)
                ? ((this.option = e),
                  this.style(e.style),
                  fetch(e.url)
                    ...
                    .then((t) => {
                      ...
                      switch (e.type || (0, i.getExt)(e.url)) {
                        case "srt": {
                          let t = (0, i.srtToVtt)(r),
                            a = e.onVttLoad(t);
                          return (0, i.vttToBlob)(a);
                        }
                        case "ass": {
                          let t = (0, i.assToVtt)(r),
                            a = e.onVttLoad(t);
                          return (0, i.vttToBlob)(a);
                        }
                        case "vtt": {
    ...
    iJ3NQ: [
      function (e, t, r, a) {
        ...
        function n(e, t) {
          let {
            constructor: r,
            template: { $player: a, $video: o },
          } = e;
          t.proxy(document, ["click", "contextmenu"], (t) => {
            (0, i.includeFromEvent)(t, a)
          ...
          t.proxy(o, "click", (t) => {
            ...
            switch (p.length) {
              case 1:
                e.emit("click", t),
                  i.isMobile ? !e.isLock && o && e.toggle() : e.toggle(),
                  (n = p);
                break;
              case 2:
                e.emit("dblclick", t),
    ...
    "905Dr": [
      function (e, t, r, a) {
        ...
        function n(e, t) {
          ...
          t.proxy(window, ["orientationchange", "resize"], () => o()),
            screen &&
              screen.orientation &&
              screen.orientation.onchange &&
              t.proxy(screen.orientation, "change", () => o());
        }
      },
      {
        "../utils": "gpvEP",
      ...
      function (e, t, r, a) {
        ...
        function s(e, t) {
          if (i.isMobile && !e.option.isLive) {
            let { $video: r, $progress: a } = e.template,
              o = null,
              s = !1,
              l = 0,
              c = 0,
              ...
              u = (t) => {
                if (1 === t.touches.length && !e.isLock) {
                  o === a && (0, n.setCurrentTime)(e, t), (s = !0);
                  let { pageX: r, pageY: i } = t.touches[0];
                  (l = r), (c = i), (p = e.currentTime);
                }
              },
              d = (t) => {
                if (1 === t.touches.length && s && e.duration) {
                  let { pageX: a, pageY: n } = t.touches[0],
                    s = (function (e, t, r, a) {
                      var o = t - a,
                        i = r - e,
                        n = 0;
                  ...
                  if ((u && !e.isRotate) || (d && e.isRotate)) {
                    let s = (0, i.clamp)((a - l) / e.width, -1, 1),
                      u = (0, i.clamp)((n - c) / e.height, -1, 1),
                      d = e.isRotate ? u : s,
                      f = o === r ? e.constructor.TOUCH_MOVE_RATIO : 1,
                      h = (0, i.clamp)(p + e.duration * d * f, 0, e.duration);
                    (e.seek = h),
                      e.emit(
                        "setBar",
                        "played",
                        (0, i.clamp)(h / e.duration, 0, 1),
                        t
                      ),
                      (e.notice.show = `${(0, i.secondToTime)(h)} / ${(0,
                      i.secondToTime)(e.duration)}`);
                  }
                }
              };
            e.option.gesture &&
              ...
              t.proxy(document, "touchend", () => {
                s && ((l = 0), (c = 0), (p = 0), (s = !1), (o = null));
              });
          }
        }
      },
      ...
      function (e, t, r, a) {
        ...
        function n(e, t) {
          let {
              option: r,
              constructor: a,
              template: { $container: o },
            } = e,
            n = (0, i.throttle)(() => {
              e.emit("view", (0, i.isInViewport)(o, a.SCROLL_GAP));
            }, a.SCROLL_TIME);
          t.proxy(window, "scroll", () => n()),
            e.on("view", (t) => {
              r.autoMini && (e.mini = !t);
            });
        }
      ...
      function (e, t, r, a) {
        ...
        class l extends s.default {
          constructor(e) {
            super(e),
              (this.name = "loading"),
              (0, i.append)(e.template.$loading, e.icons.loading);
          }
        }
        r.default = l;
      },
      ...
      function (e, t, r, a) {
        ...
        r.default = class {
          ...
          set show(e) {
            let {
              constructor: t,
              template: { $player: r, $noticeInner: a },
            } = this.art;
            e
              ? ((a.innerText = e instanceof Error ? e.message.trim() : e),
                (0, o.addClass)(r, "art-notice-show"),
                clearTimeout(this.timer),
                (this.timer = setTimeout(() => {
                  (a.innerText = ""), (0, o.removeClass)(r, "art-notice-show");
                }, t.NOTICE_TIME)))
      ...
      function (e, t, r, a) {
        ...
        class l extends s.default {
          constructor(e) {
            ...
            let { template: t, icons: r, events: a } = e,
              o = (0, i.append)(t.$state, r.state),
              n = (0, i.append)(t.$state, r.error);
            (0, i.setStyle)(n, "display", "none"),
              e.on("destroy", () => {
                (0, i.setStyle)(o, "display", "none"),
                  (0, i.setStyle)(n, "display", null);
              }),
    ...
    "1F2QO": [
      function (e, t, r, a) {
        ...
        var i = e("../utils"),
          ...
          s = o.interopDefault(n),
          l = e("bundle-text:./state.svg"),
          c = o.interopDefault(l),
          p = e("bundle-text:./check.svg"),
          u = o.interopDefault(p),
          d = e("bundle-text:./play.svg"),
          f = o.interopDefault(d),
          h = e("bundle-text:./pause.svg"),
          m = o.interopDefault(h),
          g = e("bundle-text:./volume.svg"),
          v = o.interopDefault(g),
          y = e("bundle-text:./volume-close.svg"),
          b = o.interopDefault(y),
          x = e("bundle-text:./screenshot.svg"),
          w = o.interopDefault(x),
          j = e("bundle-text:./setting.svg"),
          k = o.interopDefault(j),
          S = e("bundle-text:./arrow-left.svg"),
          E = o.interopDefault(S),
          z = e("bundle-text:./arrow-right.svg"),
          $ = o.interopDefault(z),
          I = e("bundle-text:./playback-rate.svg"),
          T = o.interopDefault(I),
          M = e("bundle-text:./aspect-ratio.svg"),
          F = o.interopDefault(M),
          P = e("bundle-text:./config.svg"),
          C = o.interopDefault(P),
          D = e("bundle-text:./pip.svg"),
          A = o.interopDefault(D),
          R = e("bundle-text:./lock.svg"),
          L = o.interopDefault(R),
          O = e("bundle-text:./unlock.svg"),
          q = o.interopDefault(O),
          _ = e("bundle-text:./fullscreen-off.svg"),
          H = o.interopDefault(_),
          V = e("bundle-text:./fullscreen-on.svg"),
          N = o.interopDefault(V),
          B = e("bundle-text:./fullscreen-web-off.svg"),
          U = o.interopDefault(B),
          Y = e("bundle-text:./fullscreen-web-on.svg"),
          W = o.interopDefault(Y),
          K = e("bundle-text:./switch-on.svg"),
          Q = o.interopDefault(K),
          X = e("bundle-text:./switch-off.svg"),
          Z = o.interopDefault(X),
          G = e("bundle-text:./flip.svg"),
          J = o.interopDefault(G),
          ee = e("bundle-text:./error.svg"),
          et = o.interopDefault(ee),
          er = e("bundle-text:./close.svg"),
          ea = o.interopDefault(er),
          eo = e("bundle-text:./airplay.svg"),
          ei = o.interopDefault(eo);
        r.default = class {
          constructor(e) {
            let t = {
              loading: s.default,
              ...
              check: u.default,
              volume: v.default,
              volumeClose: b.default,
              screenshot: w.default,
              setting: k.default,
              pip: A.default,
              arrowLeft: E.default,
              arrowRight: $.default,
              playbackRate: T.default,
              aspectRatio: F.default,
              config: C.default,
              lock: L.default,
              flip: J.default,
              unlock: q.default,
              fullscreenOff: H.default,
              fullscreenOn: N.default,
              fullscreenWebOff: U.default,
            ...
            for (let e in t)
              (0, i.def)(this, e, { get: () => (0, i.getIcon)(e, t[e]) });
          }
        };
      },
      {
        "../utils": "gpvEP",
        "bundle-text:./loading.svg": "OH22M",
        "bundle-text:./state.svg": "exeDr",
        "bundle-text:./check.svg": "jDV5m",
        "bundle-text:./play.svg": "8azN4",
        "bundle-text:./pause.svg": "5ROTD",
        "bundle-text:./volume.svg": "gd6yR",
        "bundle-text:./volume-close.svg": "3xcqi",
        "bundle-text:./screenshot.svg": "4bQmt",
        "bundle-text:./setting.svg": "8JYeE",
        "bundle-text:./arrow-left.svg": "1vtAE",
        "bundle-text:./arrow-right.svg": "89K7J",
        "bundle-text:./playback-rate.svg": "aboDI",
        "bundle-text:./aspect-ratio.svg": "iXCLk",
        "bundle-text:./config.svg": "f8v0I",
        "bundle-text:./pip.svg": "5TDKn",
        "bundle-text:./lock.svg": "7ioy7",
        "bundle-text:./unlock.svg": "8M4rv",
        "bundle-text:./fullscreen-off.svg": "iY4Nz",
        "bundle-text:./fullscreen-on.svg": "8DF0G",
        "bundle-text:./fullscreen-web-off.svg": "64eDf",
        "bundle-text:./fullscreen-web-on.svg": "gxLKk",
        "bundle-text:./switch-on.svg": "1a3p7",
        "bundle-text:./switch-off.svg": "ioXaN",
        "bundle-text:./flip.svg": "ghEK8",
        "bundle-text:./error.svg": "3iobs",
        "bundle-text:./close.svg": "dhbAn",
        "bundle-text:./airplay.svg": "hbZQA",
        "@parcel/transformer-js/src/esmodule-helpers.js": "7o2zS",
      },
    ],
    OH22M: [
    ...
    jDV5m: [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%" viewBox="0 0 24 24"><path fill="#fff" d="M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4z"/></svg>';
      },
      {},
    ],
    "8azN4": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M17.982 9.275 8.06 3.27A2.013 2.013 0 0 0 5 4.994v12.011a2.017 2.017 0 0 0 3.06 1.725l9.922-6.005a2.017 2.017 0 0 0 0-3.45"/></svg>';
      },
      {},
    ],
    "5ROTD": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M7 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2m8 0a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2"/></svg>';
      },
      {},
    ],
    gd6yR: [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M10.188 4.65 6 8H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1l4.188 3.35a.5.5 0 0 0 .812-.39V5.04a.498.498 0 0 0-.812-.39m4.258-.872a1 1 0 0 0-.862 1.804 6.002 6.002 0 0 1-.007 10.838 1 1 0 0 0 .86 1.806A8 8 0 0 0 19 11a8 8 0 0 0-4.554-7.222"/><path d="M15 11a4 4 0 0 0-2-3.465v6.93A4 4 0 0 0 15 11"/></svg>';
      },
      {},
    ],
    "3xcqi": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"><path d="M15 11a4 4 0 0 0-2-3.465v2.636l1.865 1.865A4 4 0 0 0 15 11"/><path d="M13.583 5.583A6 6 0 0 1 17 11a6 6 0 0 1-.585 2.587l1.477 1.477a8 8 0 0 0-3.446-11.286 1 1 0 0 0-.863 1.805m5.195 13.195-2.121-2.121-1.414-1.414-1.415-1.415L13 13l-2-2-3.889-3.889-3.889-3.889a.999.999 0 1 0-1.414 1.414L5.172 8H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1l4.188 3.35a.5.5 0 0 0 .812-.39v-3.131l2.587 2.587-.01.005a1 1 0 0 0 .86 1.806q.322-.154.627-.333l2.3 2.3a1.001 1.001 0 0 0 1.414-1.416M11 5.04a.5.5 0 0 0-.813-.39L8.682 5.854 11 8.172z"/></svg>';
      },
      {},
    ],
    "4bQmt": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 50 50"><path d="M19.402 6a5 5 0 0 0-4.902 4.012L14.098 12H9a5 5 0 0 0-5 5v21a5 5 0 0 0 5 5h32a5 5 0 0 0 5-5V17a5 5 0 0 0-5-5h-5.098l-.402-1.988A5 5 0 0 0 30.598 6ZM25 17c5.52 0 10 4.48 10 10s-4.48 10-10 10-10-4.48-10-10 4.48-10 10-10m0 2c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8"/></svg>';
      },
      {},
    ],
    "8JYeE": [
    ...
    "1vtAE": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path fill="#fff" d="m19.41 20.09-4.58-4.59 4.58-4.59L18 9.5l-6 6 6 6z"/></svg>';
      },
      {},
    ],
    "89K7J": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path fill="#fff" d="m12.59 20.34 4.58-4.59-4.58-4.59L14 9.75l6 6-6 6z"/></svg>';
      },
      {},
    ],
    aboDI: [
    ...
    f8v0I: [
      function (e, t, r, a) {
        t.exports =
          '<svg width="24" height="24"><path fill="#fff" d="M15 17h6v1h-6zm-4 0H3v1h8v2h1v-5h-1zm3-9h1V3h-1v2H3v1h11zm4-3v1h3V5zM6 14h1V9H6v2H3v1h3zm4-2h11v-1H10z" style="--darkreader-inline-fill:#a8a6a4"/></svg>';
      },
      {},
    ],
    "5TDKn": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 36 36"><path d="M25 17h-8v6h8zm4 8V10.98C29 9.88 28.1 9 27 9H9c-1.1 0-2 .88-2 1.98V25c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2m-2 .02H9V10.97h18z"/></svg>';
      },
      {},
    ],
    "7ioy7": [
    ...
    "8M4rv": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="icon" viewBox="0 0 1024 1024"><path fill="#fff" d="m666.752 194.517-49.365 74.112A128 128 0 0 0 384 341.333l.043 85.334h384A85.333 85.333 0 0 1 853.376 512v256a85.333 85.333 0 0 1-85.333 85.333H256A85.333 85.333 0 0 1 170.667 768V512A85.333 85.333 0 0 1 256 426.667h42.667v-85.334a213.333 213.333 0 0 1 368.085-146.816"/></svg>';
      },
      {},
    ],
    iY4Nz: [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon" viewBox="0 0 1024 1024"><path fill="#fff" d="M768 298.667h170.667V384h-256V128H768zM341.333 384h-256v-85.333H256V128h85.333zM768 725.333V896h-85.333V640h256v85.333zM341.333 640v256H256V725.333H85.333V640z"/></svg>';
      },
      {},
    ],
    "8DF0G": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon" viewBox="0 0 1024 1024"><path fill="#fff" d="M625.778 256H768v142.222h113.778v-256h-256zM256 398.222V256h142.222V142.222h-256v256zm512 227.556V768H625.778v113.778h256v-256zM398.222 768H256V625.778H142.222v256h256z"/></svg>';
      },
      {},
    ],
    "64eDf": [
    ...
    "1a3p7": [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" class="icon" viewBox="0 0 1664 1024"><path fill="#648FFC" d="M1152 0H512a512 512 0 0 0 0 1024h640a512 512 0 0 0 0-1024m0 960a448 448 0 1 1 448-448 448 448 0 0 1-448 448"/></svg>';
      },
      {},
    ],
    ioXaN: [
    ...
    dhbAn: [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon" viewBox="0 0 1024 1024"><path d="m571.733 512 268.8-268.8c17.067-17.067 17.067-42.667 0-59.733-17.066-17.067-42.666-17.067-59.733 0L512 452.267l-268.8-268.8c-17.067-17.067-42.667-17.067-59.733 0-17.067 17.066-17.067 42.666 0 59.733l268.8 268.8-268.8 268.8c-17.067 17.067-17.067 42.667 0 59.733 8.533 8.534 19.2 12.8 29.866 12.8s21.334-4.266 29.867-12.8l268.8-268.8 268.8 268.8c8.533 8.534 19.2 12.8 29.867 12.8s21.333-4.266 29.866-12.8c17.067-17.066 17.067-42.666 0-59.733z"/></svg>';
      },
      {},
    ],
    hbZQA: [
      function (e, t, r, a) {
        t.exports =
          '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"><g fill="#fff"><path d="M16 1H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h3v-2H3V3h12v8h-2v2h3a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1"/><path d="M4 17h10l-5-6z"/></g></svg>';
      },
      {},
    ],
    aqPSH: [
        ...
        class g extends h.default {
          constructor(e) {
            ...
            (this.name = "setting"),
              ...
              (this.active = null),
              (this.cache = new Map()),
              (this.option = [...this.builtin, ...t.settings]),
              t.setting &&
                (this.format(),
                this.render(),
                e.on("blur", () => {
                ...
                e.on("focus", (e) => {
                  let t = (0, m.includeFromEvent)(e, r.setting),
          ...
          get builtin() {
            let e = [],
              { option: t } = this.art;
            return (
              t.playbackRate && e.push((0, p.default)(this.art)),
              t.aspectRatio && e.push((0, l.default)(this.art)),
              t.flip && e.push((0, n.default)(this.art)),
              t.subtitleOffset && e.push((0, d.default)(this.art)),
              e
            );
          }
          traverse(e, t = this.option) {
            for (let r = 0; r < t.length; r++) {
              let a = t[r];
              e(a),
                a.selector?.length && this.traverse.call(this, e, a.selector);
            }
          }
          check(e) {
            (e.$parent.tooltip = e.html),
              this.traverse((t) => {
                (t.default = t === e),
                  t.default &&
                    t.$item &&
                    (0, m.inverseClass)(t.$item, "art-current");
              }, e.$option),
              this.render(e.$parents);
          }
            ...
            for (let o = 0; o < e.length; o++) {
              ...
              if (
                (i?.name
                  ? ((0, m.errorHandle)(
                      !a.includes(i.name),
                      `The [${i.name}] already exists in [setting]`
                    ),
                    a.push(i.name))
                  : (i.name = `setting-${this.id++}`),
                !i.$formatted)
              ) {
                (0, m.def)(i, "$parent", { get: () => t }),
                  (0, m.def)(i, "$parents", { get: () => r }),
                  (0, m.def)(i, "$option", { get: () => e });
                let a = [];
                (0, m.def)(i, "$events", { get: () => a }),
                  (0, m.def)(i, "$formatted", { get: () => !0 });
              }
          ...
          resize() {
            let {
              controls: e,
              constructor: { SETTING_WIDTH: t, SETTING_ITEM_HEIGHT: r },
              template: { $player: a, $setting: o },
            } = this.art;
            if (e.setting && this.show) {
              let i = this.active[0]?.$parent?.width || t,
                { left: n, width: s } = (0, m.getRect)(e.setting),
                { left: l, width: c } = (0, m.getRect)(a),
                p = n - l + s / 2 - i / 2,
                u =
                  this.active === this.option
                    ? this.active.length * r
                    : (this.active.length + 1) * r;
              if (
                ((0, m.setStyle)(o, "height", `${u}px`),
                (0, m.setStyle)(o, "width", `${i}px`),
                this.art.isRotate || m.isMobile)
              )
                return;
              p + i > c
          ...
          remove(e) {
            let t = this.find(e);
            (0, m.errorHandle)(t, `Can't find [${e}] in the [setting]`);
            let r = t.$option.indexOf(t);
            t.$option.splice(r, 1),
              this.inactivate(t),
              t.$item && (0, m.remove)(t.$item),
              this.render();
          }
          update(e) {
          ...
          add(e, t = this.option) {
            return (
              t.push(e), this.format(), this.createItem(e), this.render(), e
            );
          }
          createHeader(e) {
            ...
            let t = this.cache.get(e.$option),
              {
                proxy: r,
                icons: { arrowLeft: a },
                constructor: { SETTING_ITEM_HEIGHT: o },
              } = this.art,
              i = (0, m.createElement)("div");
            (0, m.setStyle)(i, "height", `${o}px`),
              (0, m.addClass)(i, "art-setting-item"),
              (0, m.addClass)(i, "art-setting-item-back");
            let n = (0, m.append)(
                i,
            ...
            (0, m.addClass)(s, "art-setting-item-left-icon"),
              (0, m.append)(s, a),
              (0, m.append)(n, s),
              (0, m.append)(n, e.$parent.html);
            let l = r(i, "click", () => this.render(e.$parents));
            e.$parent.$events.push(l), (0, m.append)(t, i);
          }
          createItem(e, t = !1) {
            if (!this.cache.has(e.$option)) return;
            let r = this.cache.get(e.$option),
              a = e.$item,
              o = "selector";
            (0, m.has)(e, "switch") && (o = "switch"),
              (0, m.has)(e, "range") && (o = "range"),
              (0, m.has)(e, "onClick") && (o = "button");
            let { icons: i, proxy: n, constructor: s } = this.art,
              l = (0, m.createElement)("div");
            (0, m.addClass)(l, "art-setting-item"),
              (0, m.setStyle)(l, "height", `${s.SETTING_ITEM_HEIGHT}px`),
              (l.dataset.name = e.name || ""),
            ...
            let c = (0, m.append)(
              ...
              u = (0, m.createElement)("div");
            switch (((0, m.addClass)(u, "art-setting-item-left-icon"), o)) {
              case "button":
              case "switch":
              case "range":
                (0, m.append)(u, e.icon || i.config);
                break;
              case "selector":
                e.selector?.length
                  ? (0, m.append)(u, e.icon || i.config)
                  : (0, m.append)(u, i.check);
            }
            (0, m.append)(c, u),
              (0, m.def)(e, "$icon", { configurable: !0, get: () => u }),
              (0, m.def)(e, "icon", {
                configurable: !0,
                get: () => u.innerHTML,
                set(e) {
                  (u.innerHTML = ""), (0, m.append)(u, e);
                },
              });
            let d = (0, m.createElement)("div");
            (0, m.addClass)(d, "art-setting-item-left-text"),
              (0, m.append)(d, e.html || ""),
              (0, m.append)(c, d),
              (0, m.def)(e, "$html", { configurable: !0, get: () => d }),
              (0, m.def)(e, "html", {
                configurable: !0,
                get: () => d.innerHTML,
                set(e) {
                  (d.innerHTML = ""), (0, m.append)(d, e);
                },
              });
            let f = (0, m.createElement)("div");
            switch (
              ((0, m.addClass)(f, "art-setting-item-right-tooltip"),
              (0, m.append)(f, e.tooltip || ""),
              (0, m.append)(p, f),
              (0, m.def)(e, "$tooltip", { configurable: !0, get: () => f }),
              (0, m.def)(e, "tooltip", {
                configurable: !0,
                get: () => f.innerHTML,
                set(e) {
                  (f.innerHTML = ""), (0, m.append)(f, e);
                },
              }),
              o)
            ) {
              case "switch": {
                let t = (0, m.createElement)("div");
                (0, m.addClass)(t, "art-setting-item-right-icon");
                let r = (0, m.append)(t, i.switchOn),
                  a = (0, m.append)(t, i.switchOff);
                (0, m.setStyle)(e.switch ? a : r, "display", "none"),
                  (0, m.append)(p, t),
                  (0, m.def)(e, "$switch", { configurable: !0, get: () => t });
                let o = e.switch;
                (0, m.def)(e, "switch", {
                  configurable: !0,
                  get: () => o,
                    ...
                    (o = e),
                      e
                        ? ((0, m.setStyle)(a, "display", "none"),
                          (0, m.setStyle)(r, "display", null))
                        : ((0, m.setStyle)(a, "display", null),
                          (0, m.setStyle)(r, "display", "none"));
                  },
                });
                break;
              }
              case "range":
                {
                  let t = (0, m.createElement)("div");
                  (0, m.addClass)(t, "art-setting-item-right-icon");
                  let r = (0, m.append)(t, '<input type="range">');
                  (r.value = e.range[0]),
                    (r.min = e.range[1]),
                    (r.max = e.range[2]),
                    (r.step = e.range[3]),
                    ...
                    (0, m.append)(p, t),
                    (0, m.def)(e, "$range", { configurable: !0, get: () => r });
                  let a = [...e.range];
                  (0, m.def)(e, "range", {
                    configurable: !0,
                    get: () => a,
                ...
                if (e.$range) {
                  if (e.onRange) {
                    let t = n(e.$range, "change", async (t) => {
                      (e.range[0] = e.$range.valueAsNumber),
                        (e.tooltip = await e.onRange.call(this.art, e, l, t));
                    });
                    e.$events.push(t);
                  }
                  if (e.onChange) {
                    let t = n(e.$range, "input", async (t) => {
                      (e.range[0] = e.$range.valueAsNumber),
                        (e.tooltip = await e.onChange.call(this.art, e, l, t));
                    });
                    e.$events.push(t);
                  }
                }
              ...
              case "selector":
                {
                  ...
                  e.$events.push(t),
                    e.default && (0, m.addClass)(l, "art-current");
                }
                break;
              case "button":
                if (e.onClick) {
                  let t = n(l, "click", async (t) => {
                    e.tooltip = await e.onClick.call(this.art, e, l, t);
                  });
                  e.$events.push(t);
                }
            }
            (0, m.def)(e, "$item", { configurable: !0, get: () => l }),
              t ? (0, m.replaceElement)(l, a) : (0, m.append)(r, l),
              e.mounted &&
                setTimeout(() => e.mounted.call(this.art, e.$item, e), 0);
          }
          render(e = this.option) {
            if (((this.active = e), this.cache.has(e))) {
              ...
              let t = (0, m.createElement)("div");
              this.cache.set(e, t),
                (0, m.addClass)(t, "art-setting-panel"),
                (0, m.append)(this.$parent, t),
                (0, m.inverseClass)(t, "art-current"),
                e[0]?.$parent && this.createHeader(e[0]);
              for (let t = 0; t < e.length; t++) this.createItem(e[t]);
            }
            this.resize();
          }
        }
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          let {
            i18n: t,
            icons: r,
            constructor: { SETTING_ITEM_WIDTH: a, FLIP: o },
          } = e;
          function n(e) {
            return t.get((0, i.capitalize)(e));
          }
          function s() {
      ...
      function (e, t, r, a) {
        ...
        function i(e) {
          let {
            i18n: t,
            icons: r,
            constructor: { SETTING_ITEM_WIDTH: a, ASPECT_RATIO: o },
          } = e;
          function i(e) {
      ...
      function (e, t, r, a) {
        ...
        function i(e) {
          let {
            i18n: t,
            icons: r,
            constructor: { SETTING_ITEM_WIDTH: a, PLAYBACK_RATE: o },
          } = e;
          function i(e) {
      ...
      function (e, t, r, a) {
        ...
        function i(e) {
          ...
          return {
            ...
            range: [0, -10, 10, 0.1],
            onChange: (t) => (
              (e.subtitleOffset = t.range[0]), t.range[0] + "s"
            ),
            mounted: (t, r) => {
    ...
    eOOz3: [
        ...
        r.default = class {
          constructor(e) {
            ...
            t.miniProgressBar && !t.isLive && this.add(s.default),
              t.lock && i.isMobile && this.add(m.default),
              t.autoPlayback && !t.isLive && this.add(u.default),
              t.autoOrientation && i.isMobile && this.add(c.default),
              t.fastForward && i.isMobile && !t.isLive && this.add(f.default);
      ...
      {
        "../utils": "gpvEP",
        "./miniProgressBar": "bAQc0",
        "./autoOrientation": "31jHc",
        "./autoPlayback": "UojkI",
        "./fastForward": "k8rjo",
        "./lock": "ifBkM",
        "@parcel/transformer-js/src/esmodule-helpers.js": "7o2zS",
          ...
          return (
            e.on("control", (t) => {
              t
                ...
                : (0, i.addClass)(e.template.$player, "art-mini-progress-bar");
            }),
          ...
          return (
            e.on("fullscreenWeb", (o) => {
              if (o) {
                ...
                ((o > n && s < l) || (o < n && s > l)) &&
                  setTimeout(() => {
                    (0, i.setStyle)(r, "width", `${l}px`),
                      (0, i.setStyle)(r, "height", `${s}px`),
                      (0, i.setStyle)(r, "transform-origin", "0 0"),
                      (0, i.setStyle)(
                        r,
                        "transform",
                        `rotate(90deg) translate(0, -${s}px)`
                      ),
                      (0, i.addClass)(r, "art-auto-orientation"),
                      (e.isRotate = !0),
                      e.emit("resize");
                  }, t.AUTO_ORIENTATION_TIME);
              } else
                (0, i.hasClass)(r, "art-auto-orientation") &&
                  ((0, i.removeClass)(r, "art-auto-orientation"),
                  (e.isRotate = !1),
                  e.emit("resize"));
            }),
            e.on("fullscreen", async (e) => {
              ...
              if (e) {
                let { videoWidth: e, videoHeight: o } = a,
                  { clientWidth: n, clientHeight: s } =
                    document.documentElement;
                if ((e > o && n < s) || (e < o && n > s)) {
                  let e = t.startsWith("portrait") ? "landscape" : "portrait";
                  await screen.orientation.lock(e),
                    (0, i.addClass)(r, "art-auto-orientation-fullscreen");
                }
              } else
                (0, i.hasClass)(r, "art-auto-orientation-fullscreen") &&
                  (await screen.orientation.lock(t),
                  (0, i.removeClass)(r, "art-auto-orientation-fullscreen"));
            }),
            {
      ...
      function (e, t, r, a) {
        ...
        function n(e) {
          let {
            ...
            c = (0, i.query)(".art-auto-playback-last", l),
            p = (0, i.query)(".art-auto-playback-jump", l),
            u = (0, i.query)(".art-auto-playback-close", l);
          (0, i.append)(u, r.close);
          let d = null;
          function f() {
            ...
            clearTimeout(d),
              ...
              r &&
                r >= o.AUTO_PLAYBACK_MIN &&
                ((0, i.setStyle)(l, "display", "flex"),
                (c.innerText = `${t.get("Last Seen")} ${(0, i.secondToTime)(
                  r
                )}`),
          ...
          return (
            e.on("video:timeupdate", () => {
              if (e.playing) {
                let t = a.get("times") || {},
                  r = Object.keys(t);
                r.length > o.AUTO_PLAYBACK_MAX && delete t[r[0]],
            ...
            c = () => {
              clearTimeout(n),
                s &&
                  ((s = !1),
                  (e.playbackRate = l),
                  (0, i.removeClass)(a, "art-fast-forward"));
            };
          return (
            r(o, "touchstart", (r) => {
              1 === r.touches.length &&
                ...
                (n = setTimeout(() => {
                  (s = !0),
                    ...
                    (0, i.addClass)(a, "art-fast-forward");
                }, t.FAST_FORWARD_TIME));
            }),
        ...
        function n(e) {
          ...
          return (
            t.add({
              name: "lock",
              mounted(t) {
                let a = (0, i.append)(t, r.lock),
                  o = (0, i.append)(t, r.unlock);
                (0, i.setStyle)(a, "display", "none"),
                  e.on("lock", (e) => {
                    e
                      ? ((0, i.setStyle)(a, "display", "inline-flex"),
                        (0, i.setStyle)(o, "display", "none"))
                      : ((0, i.setStyle)(a, "display", "none"),
                        (0, i.setStyle)(o, "display", "inline-flex"));
                  });
              },
              click() {
                o() ? s() : n();
